...
var adminPageTableMap = map[string]struct {
	...
	"goodsOrderItems": {Label: "商品订单明细管理", Tables: []string{"goods_order_items", "goods_orders", "device_guides"}},
	"users":          {Label: "用户管理", Tables: []string{"users"}},
	"userCarts":      {Label: "用户购物车管理", Tables: []string{"users", "cart_items"}},
	"cartItems":      {Label: "购物车商品明细管理", Tables: []string{"cart_items", "users", "device_guides"}},
